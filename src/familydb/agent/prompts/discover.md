...
1. Run 2 to 4 web searches that name the home area and the dates or month, for example "things to do Portland September 26 27 2026" or "family events near Vancouver WA this weekend".
2. Keep only items that happen inside the window, within about two hours of home, that a family could actually go to. Prefer official or listing pages.
