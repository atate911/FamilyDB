...
- On Telegram, /today, /week, /tasks and /now answer at once from the calendar, the task list and the ideas, with no model call: what is on, what is left to do in that chat, and what could start right now.
...
docs/             DESIGN.md, INSTALL.md for a server from zero, ALPHA_READINESS.md (what the
                  ...
                  household-memory design, and what of it is built), AI_CALLS.md (how model calls
