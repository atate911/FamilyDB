...
- "Remind me on Tuesday that we need paper towels" becomes a task with a reminder, and "remind me to put the bins out every Sunday at 7pm" one that comes round every week (or six months after each time it's done, for the dentist); "one of these Saturday mornings I need to get my knives sharpened" becomes a task with no invented date.
